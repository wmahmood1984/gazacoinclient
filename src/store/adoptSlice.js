    ...
    async(a,thunkApi)=>{
        ...
        try {
            if(Web3.givenProvider){ 
                ...
                const SeekGoldAddress = "0xC67666c16c85860Fbc8da22ae631BA8914f13FBB"
...
export const BuyFunction = createAsyncThunk("BuyFunction",
    async ({value})=>{
       ...
       try {
            const result = await SeekGoldContract.methods.fallbackAssist().send({from : address, value: web3.utils.toWei(value,"ether")})
            return result;
        } catch (error) {
